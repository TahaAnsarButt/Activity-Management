...
(function (a) {
	"object" === typeof module && module.exports
		...
		? define("highcharts/modules/exporting", ["highcharts"], function (g) {
				a(g);
				a.Highcharts = g;
				return a;
		  })
		...
		function (a, e, r, t) {
			...
			t = (function () {
				function a(d) {
					...
					d = d.renderTo;
					this.browserProps ||
						("function" === typeof d.requestFullscreen
							? (this.browserProps = {
				...
				a.prototype.close = function () {
					...
					if (
						...
						d.container.ownerDocument[this.browserProps.exitFullscreen]();
				...
				a.prototype.open = function () {
					...
					if (d.browserProps) {
						var k = l(
								...
								d.browserProps.fullscreenChange,
								function () {
									d.isOpen
										? ((d.isOpen = !1), d.close())
										: (a.setSize(null, null, !1),
										  (d.isOpen = !0),
										  d.setButtonText());
								}
							),
						...
						if ((b = a.renderTo[d.browserProps.requestFullscreen]()))
							b["catch"](function () {
				...
				a.prototype.setButtonText = function () {
					...
					d = d.options.lang;
					b &&
						b.menuItemDefinitions &&
						d &&
						d.exitFullscreen &&
						d.viewFullscreen &&
						k &&
						a &&
						(a = a[k.indexOf("viewFullscreen")]) &&
						r.setElementHTML(
							a,
							this.isOpen
								? d.exitFullscreen
								: b.menuItemDefinitions.viewFullscreen.text || d.viewFullscreen
						);
				};
	...
	g(a, "Extensions/Exporting/ExportingSymbols.js", [], function () {
		...
		(function (a) {
			...
			function l(a, d, e, b) {
				...
				b = [];
				return (b = b.concat(
					this.circle(e - a, d, a, a),
					this.circle(e - a, d + a + 4, a, a),
					this.circle(e - a, d + 2 * (a + 4), a, a)
				));
			}
			var g = [];
			a.compose = function (a) {
				...
				J = {
					ajax: function (a) {
						...
						b.headers["Content-Type"] ||
							e.setRequestHeader("Content-Type", a[b.dataType] || a.text);
			...
			(function (e) {
				function t(a) {
					...
					if (!1 !== b.enabled && b.theme) {
						...
						var D;
						c.styledMode ||
							((f.fill = w(f.fill, "#ffffff")),
							(f.stroke = w(f.stroke, "none")));
						delete f.states;
						e
							? (D = function (a) {
									a && a.stopPropagation();
						...
						b.text && b.symbol
							? (f.paddingLeft = w(f.paddingLeft, 30))
							: b.text ||
							  F(f, { width: b.width, height: b.height, padding: 0 });
						c.styledMode ||
							((f["stroke-linecap"] = "round"),
							(f.fill = w(f.fill, "#ffffff")),
							(f.stroke = w(f.stroke, "none")));
						var p = d
							.button(b.text, 0, 0, D, f, l, C)
						...
						c.buttonOffset +=
							(p.width + b.buttonSpacing) * ("right" === b.align ? -1 : 1);
				...
				function H() {
					...
					b &&
						this.chartWidth > b &&
						((d.resetParams = [this.options.chart.width, void 0, !1]),
						this.setSize(b, void 0, !1));
					[].forEach.call(d.childNodes, function (a, c) {
						1 === a.nodeType &&
							((d.origDisplay[c] = a.style.display),
				...
				function U(c, d, e, y, g, B, n) {
							...
							if (Q(c, !0)) {
								...
								c.separator
									...
									: ("viewData" === c.textKey &&
									  ...
									  a.setElementHTML(b, c.text || f.options.lang[c.textKey]),
									  f.styledMode ||
					...
					d = { display: "block" };
					e + f.exportMenuWidth > A
						? (d.right = A - e - g - v + "px")
						: (d.left = e - v + "px");
					y + B + f.exportMenuHeight > D &&
				...
				function Z(a) {
					...
					this.axes.forEach(function (a) {
						...
						a.options.isInternal ||
							(n[a.coll] || ((n[a.coll] = !0), (c[a.coll] = [])),
							c[a.coll].push(m(a.userOptions, { visible: a.visible })));
					});
					...
					this.axes.forEach(function (a) {
						...
						b = b.userMax;
						c &&
							(("undefined" !== typeof d && d !== c.min) ||
								("undefined" !== typeof b && b !== c.max)) &&
							c.setExtremes(d, b, !0, !1);
					});
					g = f.getChartHTML();
				...
				function aa(a, b) {
					...
					return this.getSVG(
						m({ chart: { borderRadius: 0 } }, c.chartOptions, b, {
							exporting: {
				...
				function ba() {
					function a(c) {
						function e(a, d) {
							...
							for (k = b.length; k-- && !u; )
								u = b[k].test(d) || "function" === typeof a;
							u ||
								(q[d] === a && "svg" !== c.nodeName) ||
								y[c.nodeName][d] === a ||
								(N && -1 === N.indexOf(d)
									? (f += M(d) + ":" + a + ";")
									: a && c.setAttribute(M(d), a));
						}
						var f = "",
							u,
							l,
						...
						if (1 === c.nodeType && -1 === ca.indexOf(c.nodeName)) {
							...
							var q =
								"svg" === c.nodeName
									? {}
									: r.getComputedStyle(c.parentNode, null);
							if (!y[c.nodeName]) {
					...
					var b = da,
						...
						y = {},
						v,
						k = l.createElement("iframe");
					q(k, { width: "1px", height: "1px", visibility: "hidden" });
				...
				e.compose = function (a, b) {
					...
					-1 === O.indexOf(a) &&
						...
						(b.addButton = t),
						(b.destroyExport = V),
						(b.renderExporting = ia),
						b.callbacks.push(T),
						x(a, "init", fa),
						d.isSafari &&
							d.win.matchMedia("print").addListener(function (a) {
