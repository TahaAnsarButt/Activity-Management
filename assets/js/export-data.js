	...
	k(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
		var f = a.isSafari,
			...
			r = (a.dataURLtoBlob = function (a) {
				if (
					...
					for (var c = 0; c < n.length; ++c) n[c] = f.charCodeAt(c);
					a = new d.Blob([n], { type: a[1] });
		...
		a = a.downloadURL = function (a, l) {
			...
			if ("string" === typeof a || a instanceof String || !n.msSaveOrOpenBlob) {
				...
				if ("undefined" !== typeof c.download)
					(c.href = a),
						(c.download = l),
		...
		function (a, f, d, p, l, r, n) {
			function k(a, m) {
				...
				try {
					...
					if (!c)
						return d.createObjectURL(new g.Blob(["\ufeff" + a], { type: m }));
				} catch (N) {}
			}
			var I = p.doc,
				c = p.seriesTypes,
			...
			f.prototype.setUpKeyToAxis = function () {
				c.arearange &&
					(c.arearange.prototype.keyToAxis = { low: "y", high: "y" });
			...
			f.prototype.getDataRows = function (b) {
				...
				this.series.forEach(function (a) {
					...
					if (
						...
						for (l = 0; l < f; )
							(z = w(a, q[l], q.length)),
								p.push(z.columnTitle || z),
								b && n.push(z.topLevelColumnTitle || z),
								l++;
						var A = {
							chart: a.chart,
						...
						a.options.data.forEach(function (b, d) {
							...
							l = 0;
							if (!e || "name" === a.exportKey || (!m && e && e.hasNames && h))
								b = h;
							g && (g[b] && (b += "|" + d), (g[b] = !0));
							t[b] || ((t[b] = []), (t[b].xValues = []));
							t[b].x = w.x;
							...
							for (t[b].xValues[k] = w.x; l < f; )
								(d = q[l]),
									...
									(t[b][x + l] = v(
										B.categoryMap[d][h],
										B.dateTimeValueAxisMap[d]
											? y.dateFormat(c.dateFormat, h)
											: null,
										h
									)),
									l++;
						...
						k &&
							...
							(k.dateTime
								? (a.x instanceof Date && (a.x = a.x.getTime()),
								  (b = y.dateFormat(c.dateFormat, a.x)))
								: (b = k.categories
			...
			f.prototype.getTableAST = function (a) {
				...
				a.forEach(function (a) {
					for (var c = [], d = 0; d < b; d++)
						c.push(n(d ? "td" : "th", null, d ? {} : { scope: "row" }, a[d]));
					u.push({ tagName: "tr", children: c });
				});
				c.push({ tagName: "tbody", children: u });
				c = {
					tree: {
						tagName: "table",
			...
			f.prototype.downloadCSV = function () {
				var a = this.getCSV(!0);
				G(
					k(a, "text/csv") || "data:text/csv,\ufeff" + encodeURIComponent(a),
			...
			f.prototype.downloadXLS = function () {
				var a =
					...
					"</body></html>";
				G(
					k(a, "application/vnd.ms-excel") ||
						"data:application/vnd.ms-excel;base64," +
							g.btoa(unescape(encodeURIComponent(a))),
			...
			f.prototype.toggleDataTable = function (a) {
				(a = v(a, !this.isDataTableVisible)) &&
					!this.dataTableDiv &&
					((this.dataTableDiv = I.createElement("div")),
				...
				this.dataTableDiv &&
					...
					a &&
						...
						new d([this.getTableAST()]).addToDOM(this.dataTableDiv),
				...
				b = this.options.lang;
				u &&
					u.menuItemDefinitions &&
					b &&
					b.viewData &&
					b.hideData &&
					c &&
					a &&
					(a = a[c.indexOf("viewData")]) &&
					d.setElementHTML(
						a,
			...
			u &&
				...
				u.buttons &&
					u.buttons.contextButton.menuItems.push(
						"separator",
						"downloadCSV",
						"downloadXLS",
						"viewData"
