                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="panel-11" class="panel">
                                ...
                                <div class="panel-container show p-1">

                                <div id="getData" class="container-fluid p-3"></div>
...
url1 = '<?php echo base_url('Classes/ClassMemberCounts'); ?>'

$.get(url1, {}, function(data) {
    // console.log("All data", data);
    let count = data.map(item => item.Membercount);
    // console.log(count);
    let sum = count.reduce((a, b) => {
           return a + b
        },0
        );
    // console.log(sum)
    ...
    if (data.length > 0) {
        ...
        data.forEach(element => {
            html += `<tr>	
            <td data-Class = "${element.deptname}">${element.deptname}</td>
                <td data-Class = "${element.Class}">${element.Class}</td>
                <td data-Membercount = ${element.Membercount}>${element.Membercount}</td>													
        </tr>`
        
        })
        html += `</tbody><tfoot>
                            
        <tr><th style='font-weight: bold; font-size: 16px'>Total Members count:</th>
        <th style='font-weight: bold; font-size: 16px'></th>

                            <th style='font-weight: bold; font-size: 16px'>${sum}</th>
                            </tr>
                            </tfoot>
                            `
        $("#getData").html(html);
