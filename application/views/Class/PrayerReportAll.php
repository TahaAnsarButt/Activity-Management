...
?>
                                ...
                                <div class="panel-container show m-1">
                                    <div class="tab-pane fade show active" id="tab_direction-1" role="tabpanel">
                                            ...
                                            <div class="row p-3 m-1">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-contol" for="customFile">Search by Month:</label>

                                                    <input type="month" class="form-control" name="startmonth_date" id="startmonth_date" value="">
                                                </div>

                                                <div class="col-md-3 mt-4">
                                                    <button  class="btn btn-primary" id="searchmonth">Search</button>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="p-3" id="fgtRequestData1">
                                    ...
                                    <!-- <ul class="nav nav-pills m-3" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#tab_direction-1">Prayer Count</a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_direction-2">View Report</a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_direction-3">View All Reports</a></li>
                                        ...
                                        <div class="tab-pane fade show active" id="tab_direction-1" role="tabpanel">
                                            ...
                                            <form method="post">
                                                <div class="row p-3 m-1">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label class="form-contol" for="customFile">Date</label>

                                                        <input type="date" class="form-control" name="start_date" id="start_date" value="<?php echo $CurrentDate ?>">
                                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="tab_direction-2" role="tabpanel">
                                        ...
                                        <div class="row p-3 m-1">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" class="form-control" name="search_date" id="search_date" value="<?php echo $CurrentDate ?>">
                                            </div>
                                            <div class="col-md-6" style="display:none">
                                                <input type="hidden" class="form-control" value="" id="HiddenTID" name="HiddenTID">
                                            </div>
                                            <div class="col-md-2 mt-4" id="sendButton">
                                                <button class="btn btn-primary" id="search_date" onclick="getPrayerDataByDate()">Search</button>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="tab_direction-3" role="tabpanel">
                                        ...
                                        <div class="row p-3 m-1">
                                            <div class="col-md-3">
                                                <label class="form-contol" for="selectdeptboxsearch">Department</label>
                                                <select name="selectdeptboxsearch" id="selectdeptboxsearch" class="form-control" onchange="getAllDeptClassEntries()">
                                                    <option value="" selected>Select Department:</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-contol" for="selectdeptClassboxsearch">Class</label>
                                                <select name="selectdeptClassboxsearch" id="selectdeptClassboxsearch" class="form-control">
                                                    <option value="" selected>Select Class:</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" class="form-control" name="searchdept_date" id="searchdept_date" value="<?php echo $CurrentDate ?>">
                                            </div>
                                            <div class="col-md-6" style="display:none">
                                                <input type="hidden" class="form-control" value="" id="HiddenTIDtab3" name="HiddenTIDtab3">
                                            </div>
                                            <div class="col-md-2 mt-4" id="sendButton">
                                                <button class="btn btn-primary" id="search_date" onclick="getdeptPrayerDataByDate()">Search</button>
                                            </div>
                                            ...
                                            <div id="getPrayerDatabydept" class="container-fluid m-3"></div>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row p-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-contol" for="customFile" style="color: white;">Name:</label>
                            <input disabled style="background-color: none; color: black;" class="form-control" value="" id="MemberName" name="MemberName">
                        </div>
                        <div class="col-md-6">
                            <label class="form-contol" for="customFile" style="color: white;">Card No:</label>
                            <input style="background-color: none; color: black;" disabled class="form-control" value="" id="MemberCardNo" name="MemberCardNo">
                        </div>
                        <div class="col-md-6">
                            <label class="form-contol" for="qty" style="color: white;">Counter:</label><span class="text-danger"> *</span>
                        ...
                        <div class="col-md-6 mt-2" id="sendButton">
                            <button class="btn btn-primary" id="savePrayerCount" style="margin-top:15px">Save</button>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            setTimeout(() => {
    document.getElementById('searchmonth').click();
}, 100);

            let date = new Date(); // Instantiate the Date object
                                                let m = date.getMonth() + 1; // Get the month (0-11), add 1 to get the correct month (1-12)
                                                let y = date.getFullYear();
                                                let fulldate = y + '-' + (m < 10 ? '0' : '') + m; // Pad the month value with leading zero if necessary
                                                $("#startmonth_date").val(fulldate);

            $("#selectdeptboxsearch").select2()

            $.get(url = '<?php echo base_url('Classes/getAllDeptEntries'); ?>',
                function(data) {


                    for (let i = 0; i < data.length; i++) {
                        $("#selectdeptboxsearch").append($(`<option>`, {
        ...
        $('#searchmonth').on('click', function(e) {
            ...
            let month = $("#startmonth_date").val().split('-')[1];
            let year = $("#startmonth_date").val().split('-')[0];

            // console.log($("#startmonth_date").val());

            // console.log(month);
            // console.log(year);


            $.post('<?php echo base_url() ?>Classes/PrayerReport3', {
                "month": month,
                "year": year
            },function(data){
            if(data){
