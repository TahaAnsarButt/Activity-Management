...
?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="panel-11" class="panel">
                                <div class="panel-hdr">
                                    <h2>
                                        Overall Department Prayers Percentage Report
                                ...
                                <div class="panel-container show m-1">
                                    <div class="tab-pane fade show active" id="tab_direction-1" role="tabpanel">
                                        ...
                                        <div class="row p-3 m-1">
                                            ...
                                            <div class="col-md-3 mt-4">
                                                    <button style="display: none;"  class="btn btn-primary" id="exportCsvButton">Export CSV</button>
                                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.post('<?php echo base_url() ?>Classes/PrayerReport4', {
                "month": month,
                "year": year
            }, function(data) {
                if (data) {
        ...
        document.getElementById("exportCsvButton").addEventListener("click", function() {
                ...
                var table = document.getElementById("defualtTable1");
        ...
        //     document.getElementById('totalpercentage').textContent = window.totalPercent;
        // });
