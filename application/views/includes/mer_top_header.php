	...
	<div class="ml-auto d-flex">
		...
		<div>
			...
			<div class="dropdown-menu dropdown-menu-animated dropdown-lg">
				...
				<a href="<?php echo base_url('MER/Logout') ?>" class="dropdown-item fw-500 pt-3 pb-3" href="page_login_alt.html">
					<span data-i18n="drpdwn.page-logout">Logout</span>
					<?php

					$LoginName =  $this->session->userdata('LoginName');
					?>
					<span class="float-right fw-n">&commat;<?php echo  $LoginName; ?></span>
				</a>
			</div>
		</div>
	</div>
