	...
	<div class="ml-auto d-flex">
		...
		<div>
			...
			<div class="dropdown-menu dropdown-menu-animated dropdown-lg">
				...
				<a href="<?php echo base_url('index.php/LoginController/logout') ?>" class="dropdown-item fw-500 pt-3 pb-3" href="page_login_alt.html">
					<span data-i18n="drpdwn.page-logout">Logout</span>
					<?php

					$LoginName =  $this->session->userdata('Username');
					?>
					<span class="float-right fw-n"><?php echo  $LoginName; ?></span>
				</a>
			</div>
		</div>
	</div>
